...
import type { MentionUserData, PostSentence, StrapiLocale } from '@fc/types'

export type HashtagStatsType = {
  unsharedCount: number
  totalSentences: number
  totalShares: number
}

export type PostStats = HashtagStatsType & {
...
export type HashtagState = {
  ...
  hashtagStats: Record<StrapiLocale, HashtagStatsType>
