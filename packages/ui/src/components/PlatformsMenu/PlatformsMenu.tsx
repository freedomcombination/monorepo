            ...
            <SimpleGrid columns={2} spacing={4}>
              <Box textAlign="center">
                <Link
                  ...
                  isExternal
                >
                  <Image src="https://dashboard.freedomcombination.com/images/foundation-logo.svg" alt="Foundation Logo" />
                  Dashboard
                </Link>
              </Box>
              <Box textAlign="center">
                <Link href="https://kunsthalte.com" isExternal>
                  <Image src="https://www.kunsthalte.com/images/kunsthalte-logo.svg" alt="Kunsthalte Logo" />
                  Kunsthalte
                </Link>
              </Box>
              <Box textAlign="center">
              ...
              <Box textAlign="center">
                <Link href="https://trendrights.com" isExternal>
                  <Image src="https://www.trendrights.com/images/trend-rights-logo-light.svg" alt="Trend Rights Logo" />
                  Trend Rights
                </Link>
              </Box>
            </SimpleGrid>
